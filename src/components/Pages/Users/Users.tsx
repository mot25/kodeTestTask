...
const Users = (props: Props) => {
  ...
  const sortUsers = () => {
    ...
    // setStateUsers(
    //   usersDemo.sort((a: UsersItemsType, b: UsersItemsType) => new Date(comapreMonth(a.birthday)).getTime() - new Date(comapreMonth(b.birthday)).getTime())
    // )
    console.log(
  ...
  console.log(
    'currentBirthdayUsers', currentBirthdayUsers,
...
// console.log('lenght', usersDemo.length);
